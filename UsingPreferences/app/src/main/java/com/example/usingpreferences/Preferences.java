...
public class Preferences {
    ...
    static final String KEY_STATUS_SEDANG_LOGIN = "Status_loggin_in";

    private static SharedPreferences getSharedPreferences(Context context) {
        // Ganti "my_prefs" dengan nama preferensi yang sesuai
        return context.getSharedPreferences("Prev_Fadil", Context.MODE_PRIVATE);
    }
